...
drop table if exists "flor" cascade;
drop table if exists "casamento_decoracao" cascade;
drop table if exists "floricultura" cascade;
drop table if exists "transporte_veiculo" cascade;
drop table if exists "casamento_floricultura" cascade;
drop table if exists "veiculo_tipo" cascade;
drop table if exists "transporte" cascade;
drop table if exists "aluga" cascade;
drop table if exists "casamento_espaco" cascade;
