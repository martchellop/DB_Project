...
"color: white")
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(60, 100, 428, 431))
...
"color: white")
        ...
        self.date_edit_start.setAutoFillBackground(False)
        self.date_edit_start.setStyleSheet("font: 14pt \"Cantarell\";\n"
"color: white")
        self.date_edit_start.setDateTime(QtCore.QDateTime(QtCore.QDate(2018, 1, 11), QtCore.QTime(0, 0, 0)))
        self.date_edit_start.setMaximumDate(QtCore.QDate(7999, 12, 31))
        self.date_edit_start.setMinimumDate(QtCore.QDate(2000, 1, 1))
        self.date_edit_start.setCalendarPopup(True)
        self.date_edit_start.setCurrentSectionIndex(0)
        self.date_edit_start.setDate(QtCore.QDate(2018, 1, 11))
...
"color: white")
        ...
        self.date_edit_end.setAutoFillBackground(False)
        self.date_edit_end.setStyleSheet("font: 14pt \"Cantarell\";\n"
"color: white")
        self.date_edit_end.setDateTime(QtCore.QDateTime(QtCore.QDate(2018, 1, 11), QtCore.QTime(0, 0, 0)))
        self.date_edit_end.setMaximumDate(QtCore.QDate(7999, 12, 31))
        self.date_edit_end.setMinimumDate(QtCore.QDate(2000, 1, 1))
        self.date_edit_end.setCalendarPopup(True)
        self.date_edit_end.setCurrentSectionIndex(0)
        self.date_edit_end.setDate(QtCore.QDate(2018, 1, 11))
...
"color: white")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.date_edit_start.setDisplayFormat(_translate("MainWindow", "d/M/yy"))
        self.label_7.setText(_translate("MainWindow", "<html><head/><body><p>e</p></body></html>"))
        self.date_edit_end.setDisplayFormat(_translate("MainWindow", "d/M/yy"))
